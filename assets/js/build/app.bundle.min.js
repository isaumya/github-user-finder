 ...
 * @returns Promises
**/
var i=function(){function t(){!function(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}(this,t),this.client_id="63efe4f7da3f2257e398",this.client_secret="c18ca07325c29934f7bf6facae47231455fd7e56",this.repo_count=5}return e(t,[{key:"getUser",value:function(){var t,n=(t=regeneratorRuntime.mark(function t(n){var r,e,i,o,u=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"created";return regeneratorRuntime.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.prev=0,t.next=3,fetch("https://api.github.com/users/"+n+"?client_id="+this.client_id+"&client_secret="+this.client_secret);case 3:if(r=t.sent,e=void 0,!r.ok){t.next=11;break}return t.next=8,r.json();case 8:e=t.sent,t.next=16;break;case 11:if(404!==r.status){t.next=15;break}throw new Error("Profile Not Found.");case 15:throw new Error("Some Network Error Happened while fetching the Users! ERROR Code: "+r.status);case 16:return t.next=18,fetch("https://api.github.com/users/"+n+"/repos?per_page="+this.repo_count+"&sort="+u+"&order=asc&client_id="+this.client_id+"&client_secret="+this.client_secret);case 18:if(i=t.sent,o=void 0,!i.ok){t.next=26;break}return t.next=23,i.json();case 23:o=t.sent,t.next=27;break;case 26:throw new Error("Some Network Error Happened while fetching the User Repos! ERROR Code: "+i.status);case 27:return t.abrupt("return",{profile:e,repos:o});case 30:throw t.prev=30,t.t0=t.catch(0),new Error(t.t0.message);case 33:case"end":return t.stop()}},t,this,[[0,30]])}),function(){var n=t.apply(this,arguments);return new Promise(function(t,r){return function e(i,o){try{var u=n[i](o),c=u.value}catch(t){return void r(t)}if(!u.done)return Promise.resolve(c).then(function(t){e("next",t)},function(t){e("throw",t)});t(c)}("next")})});return function(t){return n.apply(this,arguments)}}()}]),t}();n.default=i},function(t,n,r){"use strict";Object.defineProperty(n,"__esModule",{value:!0});var e=function(){function t(t,n){for(var r=0;r<n.length;r++){var e=n[r];e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(t,e.key,e)}}return function(n,r,e){return r&&t(n.prototype,r),e&&t(n,e),n}}();var i=function(){function t(){!function(t,n){if(!(t instanceof n))throw new TypeError("Cannot call a class as a function")}(this,t),this.profile=document.getElementById("profile")}return e(t,[{key:"clearProfile",value:function(){this.profile.innerHTML=""}},{key:"showProfile",value:function(t){this.clearAlert(),this.hideHowTo();var n=void 0;n=""===t.blog?'<span class="badge badge-warning">No Details Provided</span>':'<a href="'+t.blog+'" target="_blank">'+t.blog+"</a>";var r=void 0;r=null===t.company||""===t.company?'<span class="badge badge-warning">No Details Provided</span>':t.company;var e=void 0;e=null===t.location||""===t.location?'<span class="badge badge-warning">No Details Provided</span>':t.location;var i=void 0;i=null===t.hireable||!1===t.hireable?'<span class="badge badge-danger">No</span>':'<span class="badge badge-success">Yes</span>',this.profile.innerHTML='\n\t\t<div class="card card-body mb-3">\n\t\t\t<div class="row">\n\t\t\t\t<div class="col-md-3">\n\t\t\t\t\t<img src="'+t.avatar_url+'" class="img-fluid mb-2">\n\t\t\t\t\t<a href="'+t.html_url+'" target="_blank" class="btn btn-primary btn-block mb-3">View Profile</a>\n\t\t\t\t</div>\n\t\t\t\t<div class="col-md-9">\n\t\t\t\t\t'+this.createBadge("badge-primary","Public Repos",t.public_repos,t.login,"repositories")+"\n\t\t\t\t\t"+this.createBadge("badge-secondary","Public Gists",t.public_gists,t.login,"gists")+"\n\t\t\t\t\t"+this.createBadge("badge-success","Followers",t.followers,t.login,"followers")+"\n\t\t\t\t\t"+this.createBadge("badge-info","Following",t.following,t.login,"following")+'\n\t\t\t\t\t<div class="mb-3"></div>\n\t\t\t\t\t<ul class="list-group">\n\t\t\t\t\t\t<li class="list-group-item"><strong>Company:</strong> <span class="ml-2">'+r+'</span></li>\n\t\t\t\t\t\t<li class="list-group-item"><strong>Website/Blog:</strong> <span class="ml-2">'+n+'</span></li>\n\t\t\t\t\t\t<li class="list-group-item"><strong>Location:</strong> <span class="ml-2">'+e+'</span></li>\n\t\t\t\t\t\t<li class="list-group-item"><strong>Member Since:</strong> <span class="ml-2">'+new Date(t.created_at).toString()+'</span></li>\n\t\t\t\t\t\t<li class="list-group-item"><strong>Want to be Hired:</strong> <span class="ml-2">'+i+'</span></li>\n\t\t\t\t\t</ul>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div class="row">\n\t\t\t<div class="col-md-9">\n\t\t\t\t<h3 class="page-heading mb-3">Latest 5 Repos</h3>\n\t\t\t</div>\n\t\t\t<div class="col-md-3">\n\t\t\t\t<div class="form-group">\n\t\t\t\t\t<select id="repo-sort" class="custom-select repo-sort">\n\t\t\t\t\t\t<option disabled="disabled" selected="selected" value="0">Sort the Repos by:</option>\n\t\t\t\t\t\t<option value="1">Latest 5 Created</option>\n\t\t\t\t\t\t<option value="2">Latest 5 Updated</option>\n\t\t\t\t\t</select>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t\t<div id="repos"></div>\n\t\t'}},{key:"createBadge",value:function(t,n,r,e,i){return 0===r?'<span class="badge '+t+'">'+n+": "+r+"</span>":'<a href="'+("gists"===i?"https://gist.github.com/"+e:"https://github.com/"+e+"/"+i)+'" target="_blank"><span class="badge '+t+'">'+n+": "+r+"</span></a>"}},{key:"showRepos",value:function(t){var n=this,r="";0===t.length?r='\n\t\t\t<div class="card text-white bg-primary mb-2">\n\t\t\t\t<div class="card-body">\n\t\t\t\t\t<h4 class="card-title">So Sorry! 😟</h4>\n\t\t\t\t\t<p class="card-text">It Seems that the user has no public repositories in GitHub. May be it\'s a new profile or maybe the user has created the GitHub account, but never actually used it, in any case, there is no Github repositories to show here. Sorry! 😟</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t':t.forEach(function(t){var e=void 0;e=null===t.homepage||""===t.homepage?"":'<a href="'+t.homepage+'" target="_blank" class="btn btn-primary mb-3">Visit Homepage/Demo Website</a>';var i=void 0;i=null===t.description||""===t.description?"":'<p class="repo-description card-text">'+t.description+"</p>",r+='\n\t\t\t\t<div class="card card-body mb-2">\n\t\t\t\t\t<div class="row align-items-center">\n\t\t\t\t\t\t<div class="col-md-6">\n\t\t\t\t\t\t\t<h4 class="card-title"><a href="'+t.html_url+'">'+t.name+"</a> "+n.getLangIcon(t.language)+"</h4>\n\t\t\t\t\t\t\t"+i+"\n\t\t\t\t\t\t\t"+e+'\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div class="col-md-6 align-self-center">\n\t\t\t\t\t\t\t<span class="badge badge-warning">Stars: '+t.stargazers_count+'</span>\n\t\t\t\t\t\t\t<span class="badge badge-info">Watchers: '+t.watchers_count+'</span>\n\t\t\t\t\t\t\t<span class="badge badge-success">Forks: '+t.forks_count+"</span>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t"}),document.getElementById("repos").innerHTML=r}},{key:"getLangIcon",value:function(t){var n=void 0;switch(t){case"ASP":n='<i class="devicon-dot-net-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"C":n='<i class="devicon-c-line-wordmark colored ml-2" title="'+t+'"></i>';break;case"C++":n='<i class="devicon-cplusplus-line-wordmark colored ml-2" title="'+t+'"></i>';break;case"C#":case"Objective-C++":n='<i class="devicon-csharp-line-wordmark colored ml-2" title="'+t+'"></i>';break;case"CSS":n='<i class="devicon-html5-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"Go":n='<i class="devicon-go-plain colored ml-2" title="'+t+'"></i>';break;case"HTML":n='<i class="devicon-html5-plain-wordmark colored ml-2"></i>';break;case"Java":n='<i class="devicon-java-plain colored ml-2" title="'+t+'"></i>';break;case"JavaScript":n='<i class="devicon-javascript-plain orange-colored ml-2" title="'+t+'"></i>';break;case"LESS":n='<i class="devicon-less-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"Python":n='<i class="devicon-python-plain-wordmark orange-colored ml-2" title="'+t+'"></i>';break;case"Rails":n='<i class="devicon-rails-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"Ruby":n='<i class="devicon-ruby-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"SASS":n='<i class="devicon-sass-original colored ml-2" title="'+t+'"></i>';break;case"Swift":n='<i class="devicon-swift-plain-wordmark colored ml-2" title="'+t+'"></i>';break;case"TypeScript":n='<i class="devicon-typescript-plain colored ml-2" title="'+t+'"></i>';break;default:n=null===t?"":'<span class="badge badge-info lang-badge ml-3">Language: '+t+"</span>"}return n}},{key:"showAlert",value:function(t,n){var r=this;this.clearAlert();var e=document.createElement("div");e.className=n,e.appendChild(document.createTextNode(t));var i=document.querySelector(".search-container"),o=document.querySelector(".search");i.insertBefore(e,o),setTimeout(function(){r.clearAlert()},3e3)}},{key:"clearAlert",value:function(){var t=document.querySelector(".alert");t&&t.remove()}},{key:"hideHowTo",value:function(){document.getElementById("how-to").style.display="none"}},{key:"showHowTo",value:function(){document.getElementById("how-to").style.display="block"}}]),t}();n.default=i},function(t,n,r){(function(n,r){
/*!
