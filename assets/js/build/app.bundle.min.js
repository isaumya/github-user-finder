...
var _githubFinderClasses = __webpack_require__(/*! ./github-finder-classes */ "./assets/js/source/github-finder-classes.js");

var _githubFinderClasses2 = _interopRequireDefault(_githubFinderClasses);

var _uiClasses = __webpack_require__(/*! ./ui-classes */ "./assets/js/source/ui-classes.js");

var _uiClasses2 = _interopRequireDefault(_uiClasses);
...
var github = new _githubFinderClasses2.default();
// Init UI Class
var ui = new _uiClasses2.default();
...
searchUser.addEventListener('keyup', function (e) {
   ...
   * 
  **/
		github.getUser(userName).then(function (response) {
...
document.getElementById('profile').addEventListener('click', function (e) {
	if (e.target.classList.contains('repo-sort')) {
		...
		if (selectIndex !== e.target.selectedIndex) {
			...
			if (selectIndex === 0) {
				github.getUser(userName, 'created').then(function (response) {
				...
				github.getUser(userName, 'pushed').then(function (response) {
					ui.showRepos(response.repos);
				}).catch(function (err) {
					ui.showAlert(err, 'alert alert-danger');
				});
...
/***/ "./assets/js/source/github-finder-classes.js":
/*!***************************************************!*\
  !*** ./assets/js/source/github-finder-classes.js ***!
  \***************************************************/
/*! no static exports found */
...
var GitHubFinder = function () {
	function GitHubFinder() {
		_classCallCheck(this, GitHubFinder);
	...
	_createClass(GitHubFinder, [{
		key: 'getUser',
		value: function () {
			var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user) {
				var repo_sort = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'created';
				var profileResponse, profileData, repoResponse, repoData;
				return regeneratorRuntime.wrap(function _callee$(_context) {
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 16:
								_context.next = 18;
								return fetch('https://api.github.com/users/' + user + '/repos?per_page=' + this.repo_count + '&sort=' + repo_sort + '&order=asc&client_id=' + this.client_id + '&client_secret=' + this.client_secret);
...
exports.default = GitHubFinder;

/***/ }),

/***/ "./assets/js/source/ui-classes.js":
/*!****************************************!*\
  !*** ./assets/js/source/ui-classes.js ***!
  \****************************************/
/*! no static exports found */
...
var UI = function () {
	...
	_createClass(UI, [{
		...
		key: 'createBadge',
		value: function createBadge(className, heading, count, userName, urlModifier) {
			if (count === 0) {
				...
				var url = urlModifier === 'gists' ? 'https://gist.github.com/' + userName : 'https://github.com/' + userName + '/' + urlModifier;
		...
		key: 'getLangIcon',
		value: function getLangIcon(lang) {
			var langIcon = void 0;
			switch (lang) {
				case "ASP":
...
/***/ 0:
/*!******************************************************!*\
  !*** multi babel-polyfill ./assets/js/source/app.js ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./assets/js/source/app.js */"./assets/js/source/app.js");
